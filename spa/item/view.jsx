                            ...
                            <section className="itemFundamentals">
                                ...
                                <section className="itemFundamentalsThing">
                                    ...
                                    <section className="itemSide">
                                        <a className="ItemPrice" target="_blank" href={window.context.uniswapInfoUrlTemplate.format(item.address)}>Pair Info</a>
                                        <a className="ItemPrice" target="_blank" href={window.context.uniswapSpawUrlTemplate.format(item.address)}>Uniswap | {item.dynamicData && <span>$ {item.dynamicData.tokenPriceInDollarsOnUniswap ? window.formatMoney(item.dynamicData.tokenPriceInDollarsOnUniswap, 1) : ""}</span>}</a>
                                        <a className="ItemPrice" target="_blank" href={window.context.openSeaItemLinkTemplate.format(item.collection.address, item.objectId)}>Opensea | {item.dynamicData && <span> $ {item.dynamicData.tokenPriceInDollarsOnOpenSea ? window.formatMoney(item.dynamicData.tokenPriceInDollarsOnOpenSea, 1) : ""}</span>}</a>
                                    </section>
                                    {item.dynamicData && <section className="itemSide">
                                        ...
                                        <br />
                                            {this.props.item.dynamicData && this.props.item.dynamicData.canMint && 
