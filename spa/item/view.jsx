                    ...
                    <section className="itemPageInfo">
                        ...
                        <article className="itemInfo">
                            ...
                            <section className="itemSide">
                                ...
                                <span className="ItemPrice">&#129412; $ {item.dynamicData.tokenPriceInDollarsOnUniswap ? window.formatMoney(item.dynamicData.tokenPriceInDollarsOnUniswap) : "--"} <a target="_blank" href={window.context.uniswapSpawUrlTemplate.format(item.address)}>Swap</a><a target="_blank" href={window.context.uniswapInfoUrlTemplate.format(item.address)}>Info</a></span>
                                <span className="ItemPrice">&#9973; $ {item.dynamicData.tokenPriceInDollarsOnOpenSea ? window.formatMoney(item.dynamicData.tokenPriceInDollarsOnOpenSea) : "--"} <a target="_blank" href={window.context.openSeaItemLinkTemplate.format(this.props.collection.address, item.objectId)}>Info</a></span>
                            </section>
                        </article>
                    </section>
