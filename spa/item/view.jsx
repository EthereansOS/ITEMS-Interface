                    ...
                    <section className="itemPageInfo">
                        ...
                        <article className="itemInfo">
                            <section className="itemFundamentals">
                                ...
                                {false && <span className="ItemCollectionLink">wimd.item.eth.link</span>}
                                <span className="ItemCollectionLink">Link: <a target="_blank" onClick={window.copyHREF} href={window.getHomepageLink(`?wrappedItem=${this.props.item.address}`)} className="collectionLink">{window.getHomepageLink(`?wrappedItem=${this.props.item.address}`)}</a></span>
                                {this.props.collection.external_url && this.props.showLink && <span className="ItemCollectionLink">External URL: <a target="_blank" onClick={window.copyHREF} href={window.formatLink(this.props.collection.external_url)} className="collectionLink">{window.formatLinkForExpose(this.props.collection.external_url)}</a></span>}
                                {this.props.collection.externalDNS && this.props.showLink && <span className="ItemCollectionLink">External DNS: <a target="_blank" onClick={window.copyHREF} href={window.formatLink(this.props.collection.externalDNS)} className="collectionLink">{window.formatLinkForExpose(this.props.collection.externalDNS)}</a></span>}
                                {this.props.collection.externalENS && this.props.showLink && <span className="ItemCollectionLink">External ENS: <a target="_blank" onClick={window.copyHREF} href={window.formatLink(this.props.collection.externalENS)} className="collectionLink">{window.formatLinkForExpose(this.props.collection.externalENS)}</a></span>}
                                {this.props.collection.repoUri && this.props.showLink && <span className="ItemCollectionLink">Repo URI: <a target="_blank" onClick={window.copyHREF} href={window.formatLink(this.props.collection.repoUri)} className="collectionLink">{window.formatLinkForExpose(this.props.collection.repoUri)}</a></span>}
                                {this.props.collection.licence_url && this.props.showLink && <span className="ItemCollectionLink">Collection Licence URL: <a target="_blank" onClick={window.copyHREF} href={window.formatLink(this.props.collection.licence_url)} className="collectionLink">{window.formatLinkForExpose(this.props.collection.licence_url)}</a></span>}
                                ...
                                <section className="itemFundamentalsThing">
                                    ...
                                    {item.dynamicData && item.dynamicData.isEditable && item.collection.extensionAddress && item.collection.extensionAddress !== window.voidEthereumAddress && <span>Editable by {item.collection.extensionIsContract ? "Contract" : "Wallet"}: <a target="_blank" href={`${window.getNetworkElement('etherscanURL')}address/${item.collection.extensionAddress}`}>{item.collection.extensionAddress}</a></span>}
